        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        <h3 class="text-lg font-medium">{{ __('Add New User') }}</h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Create citizen, staff, or admin
                            accounts.</p>
                    </div>
                        ...
                        <div>
                            ...
                            <select id="role" name="role"
                                ...
                                @foreach (['citizen' => 'Citizen', 'staff' => 'Staff', 'admin' => 'Admin'] as $value => $label)
                                    <option value="{{ $value }}" {{ old('role', 'citizen') === $value ? 'selected' : '' }}>
                                        {{ $label }}</option>
                                @endforeach
                            </select>
