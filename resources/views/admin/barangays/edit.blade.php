                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Modify details for the selected barangay record.') }}
                        </p>
                    </div>
                    ...
                    <form action="{{ route('admin.barangays.update', $barangay->id) }}" method="POST" class="space-y-6 max-w-xl">
                        ...
                        <div>
                            ...
                            <!-- Value property safely handles Eloquent objects and falls back to session flash data if validation fails -->
                            <x-text-input id="name" name="name" type="text" :value="old('name', is_array($barangay) ? $barangay['name'] : $barangay->name)"
